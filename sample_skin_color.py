...
def calculate_mask_thresholds(sample):
  ...
  val_low_offset = hsv_mean[2] - val_offset if hsv_mean[2] - val_offset > 0 else 0
  ...
  return [[hue_low_offset, sat_low_offset, val_low_offset], [hue_high_offset, sat_high_offset, val_high_offset]]
